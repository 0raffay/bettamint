    ...
    MultiSelect.prototype = {
        ...
        load: function () {
            ...
            var placeholder = $(instance.element)
                .siblings(
                    "#ms-list-" + instance.listNumber + ".ms-options-wrap"
                )
            ...
            if (instance.options.maxPlaceholderWidth) {
                placeholder.css(
                    "maxWidth",
                    instance.options.maxPlaceholderWidth
                );
            }
                    ...
                    if (!$(event.target).closest(".ms-options-wrap").length) {
                        $(".ms-options-wrap.ms-active > .ms-options").each(
                            function () {
                                ...
                                // USER CALLBACK
                                if (
                                    typeof thisInst.options.onControlClose ==
                                    "function"
                                ) {
                                    thisInst.options.onControlClose(
                                        thisInst.element
                                    );
                                }
                            }
            ...
            placeholder
                .on("mousedown", function (event) {
                    ...
                    if (
                        ...
                        // USER CALLBACK
                        if (
                            typeof instance.options.onControlOpen == "function"
                        ) {
                        ...
                        typeof instance.options.onControlClose == "function"
                    ) {
            ...
            if (instance.options.texts.placeholder) {
                placeholder
                    .find("span")
                    .text(instance.options.texts.placeholder);
            }
                ...
                search.on("keyup", function () {
                    ...
                    $(this).data(
                        ...
                        setTimeout(function () {
                            ...
                            // USER CALLBACK
                            if (
                                typeof instance.options.searchOptions
                                    .onSearch == "function"
                            ) {
            ...
            optionsWrap.on("click", ".ms-selectall", function (event) {
                ...
                var select = optionsWrap
                    .parent()
                    .siblings(
                        ".ms-list-" + instance.listNumber + ".jqmsLoaded"
                    );
                ...
                if ($(this).hasClass("global")) {
                    ...
                    if (
                        ...
                        optionsList
                            .find(
                                'li.selected input[type="checkbox"]:not(:disabled)'
                            )
                            .prop("checked", true);
                    }
                    // deselect everything
                        ...
                        $(this)
                            ...
                            .each(function () {
                                ...
                                for (
                                    var i = 0;
                                    i <
                                    instance.options.optionAttributes.length;
                                    i++
                                ) {
                                    var thisOptAttr =
                                        instance.options.optionAttributes[i];

                                    if (
                                        $(this).attr(thisOptAttr) !== undefined
                                    ) {
                                        thisOptionAtts[thisOptAttr] =
                                            $(this).attr(thisOptAttr);
                                    }
                                }
            ...
            optionsWrap.on("click", 'input[type="checkbox"]', function () {
                ...
                select
                    .find(
                        'option[value="' +
                            instance._escapeSelector($(this).val()) +
                            '"]'
                    )
        ...
        loadOptions: function (options, overwrite, updateSelect) {
            ...
            updateSelect =
                typeof updateSelect == "boolean" ? updateSelect : true;
            ...
            if (
                ...
                var chkbx = optionsList.find(
                    '.ms-reflow:eq(0) input[type="checkbox"]'
                );
                if (chkbx.length) {
                    ...
                    optionsList
                        ...
                        .css(
                            "padding-left",
                            parseInt(
                                chkbx.closest("label").css("padding-left")
                            ) *
                                2 +
                                checkboxWidth
                        );
