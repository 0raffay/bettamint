    ...
    <div class="evenColumns flex-wrap">
      <div class="footerMainText">
        ...
        <ul class="footerIcons d-flex align-items-center gap-15 list-unstyled">
          ...
          <li><a target="_blank" href="https://twitter.com/bettamint?s=11&t=vnP8WGiCrK3bnOR_asU9jQ"><i class="ri-twitter-fill"></i></a></li>
          <li><a target="_blank" href="https://www.instagram.com/bettamint.tech/?igshid=YmMyMTA2M2Y%3D"><i class="ri-instagram-line"></i></a></li>
          <li><a target="_blank" href="https://www.youtube.com/channel/UCh4gsO2eIJIkyU7qjRWQ_9w"><i class="ri-youtube-fill"></i></a></li>
        </ul>
      </div>
      <div class="footerNavWrapper mb-40 evenColumns">
        <div>
        ...
        <div>
          <h6 class="footer__title">Downloads</h6>
          <ul class="footer_list list-unstyled">
            <li><a target="_blank" href="https://play.google.com/store/apps/details?id=com.bettamint"><i class="ri-google-play-fill me-2 fs-18"></i> Workers App</a></li>
            <li><a target="_blank" href="https://play.google.com/store/apps/details?id=com.bettamintcontractor"><i class="ri-google-play-fill me-2 fs-18"></i> Builder App</a></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="d-flex align-items-center justify-content-between">
      <div class="footerTerms">
        <ul class="footerTermList">
          ...
          <li><a href="worker-services-agreement.php">Worker Services Agreement</a></li>
          <li><a href="terms-of-use.php">Terms of Use</a></li>
          <li><a href="privacy-policy.php">Privacy Policy</a></li>
        </ul>
        <span>bettamint.com © 2024 All rights reserved.</span> </div>
      <div class="footerLogo"> <img src="assets/images/logo-green.png" alt="Reload Page"> </div>
    </div>
  </div>
</footer>
