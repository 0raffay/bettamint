    ...
    <div class="container py-md-5">
      ...
      <ul class="row align-items-center text-center px-3 px-md-0">
        ...
        <li class="col-sm-6 col-lg-2 px-3 px-sm-0">
          <img src="assets//images/good-company/11.png" width="125" height="104" alt="Reload Page">
        </li>
        <li class="col-sm-6 col-lg-2 px-3 px-sm-0">
          <img src="assets//images/good-company/4.png" width="160" height="59" alt="Reload Page">
        </li>
        <li class="col-sm-6 col-lg-2 px-3 px-sm-0">
          <img src="assets//images/good-company/2.png" width="125" height="109" alt="Reload Page">
        </li>
      </ul> 
    </div>
  </section>
