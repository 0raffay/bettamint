...
<section class="banner homeBanner prop-bottom-left">
  ...
  <a class="bannerToggleButton" href="#solutions"> <span class="dot"></span> </a> </section>
<!--==== Banner end ====--> 
    ...
    <div class="row row-gap-3 row-gap-md-4 row-gap-lg-5">
      <div class="col-xl-6">
        <h4 class="section_heading fc-white">Solutions Purpose-built <br>
          for you</h4>
        <p class="fs-18 fc-white">Bettamint is a digital ecosystem transforming frontline workforce management for the construction industry. We power developers and contractors with the tools and resources needed to fast-track their projects, control costs and maximize returns.</p>
      </div>
      <div class="col-sm-12 col-md-12 col-xl-6">
        <div class="horizontalCard d-flex align-items-xl-center flex-column flex-lg-row">
          ...
          <div class="text_wrap">
            ...
            <p class="fw-400 fs-22 mb-2 mb-md-3 fc-white">Take control with visibility every
              step of the way</p>
            <a href="developers.php" class="fc-primary fw-600 fs-22 no-hover-black hover-underline">More Details <i class="fa-solid fa-arrow-right-long fs-18 ms-2 ms-lg-3"></i></a> </div>
        </div>
      </div>
      <div class="col-sm-12 col-md-6 col-xl-6">
        <div class="horizontalCard d-flex flex-column flex-xl-row align-items-center">
          ...
          <div class="text_wrap">
            ...
            <p class="fw-400 fs-22 mb-2 mb-md-3 fc-white">Deliver on time and on budget from
              the palm of your hand</p>
            <a href="general-contractor.php" class="fc-primary fw-600 fs-22 no-hover-black hover-underline">More Details <i class="fa-solid fa-arrow-right-long fs-18 ms-2 ms-lg-3"></i></a> </div>
        </div>
      </div>
      <div class="col-sm-12 col-md-6 col-xl-6">
        <div class="horizontalCard d-flex flex-column flex-xl-row align-items-center">
          ...
          <div class="text_wrap">
            ...
            <p class="fw-400 fs-22 mb-2 mb-md-3 fc-white">Connect your teams from site to
              office in real time</p>
            <a href="sub-contractors.php" class="fc-primary fw-600 fs-22 no-hover-black hover-underline">More Details <i class="fa-solid fa-arrow-right-long fs-18 ms-2 ms-lg-3"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container container-large position-relative">
    <div class="productSectionWrapper d-flex align-items-center">
      <div class="productSectionText">
        ...
        <a href="https://calendly.com/kezyadebraganca/introduction-to-bettamint" class="primary-link-button">See All Products <i class="arrow-right-icon-green"></i></a> </div>
        ...
        <div class="productCardContainer">
          <div class="productCard">
            ...
            <div class="productCardText">
              ...
              <a href="project-management.php" class="secondary-link-button text-end w-100 justify-content-end pe-1"> Learn More <i class="arrow-right-icon-purple"></i> </a> </div>
          </div>
          <div class="productCard">
            ...
            <div class="productCardText">
              ...
              <a href="workforce-management.php" class="secondary-link-button text-end w-100 justify-content-end pe-1"> Learn More <i class="arrow-right-icon-purple"></i> </a> </div>
          </div>
        </div>
        <div class="productCardContainer">
          <div class="productCard">
            ...
            <div class="productCardText">
              ...
              <a href="financial-management.php" class="secondary-link-button text-end w-100 justify-content-end pe-1"> Learn More <i class="arrow-right-icon-purple"></i> </a> </div>
          </div>
          <div class="productCard">
            ...
            <div class="productCardText">
              ...
              <a href="construction-intelligence.php" class="secondary-link-button text-end w-100 justify-content-end pe-1"> Learn More <i class="arrow-right-icon-purple"></i> </a> </div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row align-items-center justify-content-between">
      <div class="col-xl-6">
        <h4 class="section_heading">Support Beyond Software that
          Only We Provide</h4>
        <a target="_blank" href="https://calendly.com/kezyadebraganca/introduction-to-bettamint" class="primary-link-button fs-18">Get a Personalised Demo <i class="arrow-right-icon-green"></i></a> </div>
      <div class="col-xl-5">
        <ul class="supportList list-unstyled">
          <li class="supportCard d-flex align-items-center"> <img class="flex-shrink-0" src="assets/images/support-icon-1.png" alt="Reload Page">
            <div class="text_wrap"> <a class="fs-25 fw-600 fc-black lh-normal d-flex align-items-center gap-3"> Round the Clock Support <i class="arrow-right-icon-black"></i> </a>
              <p>Connect with a Bettamint expert via email, chat or phone support at any time.</p>
            </div>
          </li>
          <li class="supportCard d-flex align-items-center"> <img class="flex-shrink-0" src="assets/images/support-icon-2.png" alt="Reload Page">
            <div class="text_wrap"> <a class="fs-25 fw-600 fc-black lh-normal d-flex align-items-center gap-3"> Seamless Implementation <i class="arrow-right-icon-black"></i> </a>
              <p>We understand your business first but more importantly, we help you go live in less than 24 hours. </p>
            </div>
          </li>
          <li class="supportCard d-flex align-items-center"> <img class="flex-shrink-0" src="assets/images/support-icon-3.png" alt="Reload Page">
            <div class="text_wrap"> <a class="fs-25 fw-600 fc-black lh-normal d-flex align-items-center gap-3"> Industry Partnerships <i class="arrow-right-icon-black"></i> </a>
              <p>Access a host of benefits from accredited partners including construction finance, earned wage, insurance and more. </p>
            </div>
          </li>
        </ul>
      </div>
