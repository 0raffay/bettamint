		...
		<div class="container container-large position-relative">
			<div class="productSectionWrapper d-flex align-items-center">
				...
				<div class="productCardWrapper">
					<!-- props -->
					<img class="prop prop-top-left" src="assets/images/prop-xs.png" alt="Reload Page">
					<img class="prop prop-bottom-right" src="assets/images/prop-lg.png" alt="Reload Page">
					<!-- props -->
